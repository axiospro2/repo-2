...
def register_exception_handlers(app: FastAPI) -> None:
    ...
    async def _dominio(_: Request, e: DominioError):
        ...
        _logger.exception("faturamento.erro_dominio", extra={"ctx": {"event": "faturamento.erro_dominio"}})
    ...
    async def _unhandled_exception(request: Request, e: Exception):
        ...
        _logger.exception("faturamento.erro_nao_tratado",
            extra={"ctx": {
        ...
        return JSONResponse(status_code=500, content={"erro": "Internal Server Error", "tipo": type(e).__name__})
